...
public class LogIn{
    ...
    public static void main(String[] args) {
        ...
        if( u.equals("User")  && p.equals("Password123") ){ // if credentials are valid
            ...
            while( !(u.equals("User")  && p.equals("Password123")) &&  attempts > 0 ){ // while the credentials are invalid, and user has attempts to reenter
            ...
            if(u.equals("User")  && p.equals("Password123")){
                System.out.println("Logged in");
            }else{
